...
namespace Service_Solution
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "Service_Solution.ContractType".
    [DataContract]
